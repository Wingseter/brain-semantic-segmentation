...
class BrainDataset(BaseCacheDataset):
    ...
    def train_dataset(self):
        ...
        """
        return CacheDataset(data=self.train_data_dicts, transform=self.train_transform, cache_rate=self.cache_rate, num_workers=self.num_workers)

    def valid_dataset(self):
        """
        Returns a CacheDataset for the validation data.
        """
        return CacheDataset(data=self.valid_data_dicts, transform=self.valid_transform, cache_rate=self.cache_rate, num_workers=self.num_workers)
